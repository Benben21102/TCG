...
export const BASE_CARDS: Card[] = [
  ...
  { name: "Banana Brawlers", cost: 3, type: "unit", atk: 2, hp: 2, keyword: "", effect: "banana", level: 3 },
  ...
  { name: "Grave Recall", cost: 4, type: "spell", effect: "summonTop2Grave", keyword: "Spell", level: 4 },
...
export const EXTRA_POOL_TEMPLATE: Card[] = [
  { name: "Extra Goer (Rush)", atk: 1, hp: 1, keyword: "Rush", cost: 0, type: "unit" as const, level: 1 },
  { name: "Extra Goer (Rush)", atk: 1, hp: 1, keyword: "Rush", cost: 0, type: "unit" as const, level: 1 },
  { name: "Extra Goer (Lifesteal)", atk: 1, hp: 1, keyword: "Lifesteal", cost: 0, type: "unit" as const, level: 1 },
  { name: "Extra Goer (Lifesteal)", atk: 1, hp: 1, keyword: "Lifesteal", cost: 0, type: "unit" as const, level: 1 },
];
